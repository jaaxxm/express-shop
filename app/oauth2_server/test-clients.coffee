...
encodeClientCredentials = (clientId, clientSecret) ->
  credentials = new Buffer(clientId + ":" + clientSecret).toString("base64")
  credentials

printClientInfo = (client, description) ->
  console.log "-------------------------------------------"
  ...
  console.log "based64 credentials: " + encodeClientCredentials(client.clientId, client.clientSecret)
  return
...
module.exports = ->
  ...
  , (err, thirdPartyClient) ->
    throw new Error()  if err
    if thirdPartyClient is null
